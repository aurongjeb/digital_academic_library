...
{               ?>                                      
                                        <tr class="odd gradeX">
											...
											<a href="manage-issued-books.php?del=<?php echo htmlentities($result->rid);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
